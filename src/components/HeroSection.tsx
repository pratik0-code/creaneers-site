    ...
    return (
        <section className="relative h-[90vh] w-full overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0 bg-neutral-200 dark:bg-neutral-800">
                ...
                <div className="w-full h-full bg-stone-300 dark:bg-neutral-800 relative animate-pulse">
            ...
            <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto font-poppins">
                ...
                <Link
                    href="/works"
                    className="inline-block border border-white px-8 py-3 text-sm uppercase tracking-widest text-white transition-all duration-300 hover:bg-white hover:text-black no-underline"
                >
                    View Projects
                </Link>
            </div>
