...
export default function ContactPage() {
    ...
    return (
        <div className="bg-white dark:bg-neutral-950 min-h-screen pt-32 pb-24 px-6 md:px-12 flex flex-col md:flex-row gap-12 max-w-7xl mx-auto">
            <div className="flex-1">
                ...
                <div className="flex flex-col space-y-8">
                    <div>
                        ...
                        <a href="mailto:studio.creaneers@gmail.com" className="text-xl border-b border-black dark:border-white pb-1 text-inherit hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors">studio.creaneers@gmail.com</a>
                    </div>
                    <div>
                ...
                {status === 'success' ? (
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col space-y-6">
                        ...
                        <div>
                            ...
                            <input required name="name" type="text" id="name" className="w-full bg-white dark:bg-neutral-800 border-none p-4 text-neutral-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-neutral-900 dark:focus:ring-white placeholder:text-neutral-400" placeholder="Your Name" />
                        </div>
                        <div>
                            ...
                            <input required name="email" type="email" id="email" className="w-full bg-white dark:bg-neutral-800 border-none p-4 text-neutral-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-neutral-900 dark:focus:ring-white placeholder:text-neutral-400" placeholder="your@email.com" />
                        </div>
                        <div>
                            ...
                            <textarea required name="message" id="message" rows={6} className="w-full bg-white dark:bg-neutral-800 border-none p-4 text-neutral-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-neutral-900 dark:focus:ring-white placeholder:text-neutral-400" placeholder="Tell us about your project..."></textarea>
                        </div>
                        ...
                        <button
                            ...
                            type="submit"
                            className="bg-black dark:bg-white text-white dark:text-black px-8 py-3 uppercase text-xs tracking-widest cursor-pointer w-full md:w-auto transition-colors hover:bg-neutral-800 dark:hover:bg-neutral-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
